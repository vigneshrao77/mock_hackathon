...
export default function TeacherProfile() {
  ...
  return (
    <div>
      <PageHeader title="Teacher Profile" subtitle="Manage your account details and contact preferences" />

      <Grid gutter="md">
        <Grid.Col span={{ base: 12, md: 4 }}>
          <Card withBorder padding="lg" radius="md">
            <Stack align="center" gap="xs">
              <Avatar size={90} radius="xl" color="navy">{user?.name.slice(0, 2).toUpperCase()}</Avatar>
          ...
          <Card withBorder padding="lg" radius="md">
            <Stack gap="sm">
              ...
              <Group justify="flex-end" mt="md">
                <Button color="navy">Save Changes</Button>
              </Group>
            </Stack>
          </Card>
        </Grid.Col>
